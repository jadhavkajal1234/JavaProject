...
public class CarPriceEstimator {
    ...
    public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven,
        ...
        System.out.println("salePrice for security features: " + salePrice);
        ...
        System.out.println("saleprice for comfort features: " + salePrice);
        ...
        System.out.println("salePrice after past accidents: " + salePrice);
